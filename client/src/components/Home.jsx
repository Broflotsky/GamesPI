...
import { filterDiet, getReceipes, orderbyName, orderByScore } from '../actions';
...
const[recipesPerPage, setrecipesPerPage] = useState(9)  // LO SUBÍ A 10 PARA QUE LA PAGINA QUEDARA MAS ARMONICA.
...
return (
    <div>
        ...
        {/* MAPEO CON CARD MI ARRAY DE STATE GLOBAL (RECETAS) */}
